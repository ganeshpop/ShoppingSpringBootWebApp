...
<head>
    <title>Menu</title>
    <link rel="stylesheet" href='<c:url value="dist/css/shoppingMenuStyle.css"/>'>
    <meta charset="utf-8">
                ...
                <div class="container-sm">
                    <div class="pricing-inner section-inner">
                        <div class="pricing-header text-center">
                            <h2 class="section-title mt-0">Welcome To City Mart User ${user.name.toUpperCase()}</h2>
                                ...
                                <div class="pricing-table-inner is-revealing">
                                    <div class="pricing-table-main">
                                        ...
                                        <div class="pricing-table-header pb-24">
                                            <div class="pricing-table-price"><span
                                                    class="pricing-table-price-amount h2">Previous Order Details</span></div>
                                            <div class="pricing-table-price" style="padding-top: 10px"><span
                                                    class="pricing-table-price-currency h4">$</span><span
                                                    class="pricing-table-price-amount h3">${lastOrder.totalFare}</span><span
                                                    class="text-xs">&nbsp;(Total Fare)</span></div>
                                        </div>
                                        <ul class="pricing-table-features list-reset text-xs">
                                            <li>
                                                <span> Number Of Items In Purchased :<dataTag
                                                        style="color: white; margin: 0; padding: 0;"> ${lastOrder.itemCount}&nbsp;</dataTag> </span>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="pricing-table-cta mb-8">
                                        <a class="button button-primary button-shadow button-block"
                                           href="viewOrder?orderId=${lastOrder.id}">View Details</a>
                                    </div>
                                </div>
