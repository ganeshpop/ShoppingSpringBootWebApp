                ...
                <div class="container-sm">
                    <div class="pricing-inner section-inner">
                        <div class="pricing-header text-center">
                            <h2 class="section-title mt-0">Welcome To City Mart User ${user.name}</h2>
                                ...
                                <div class="pricing-table-inner is-revealing">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header pb-24">
                                            ...
                                            <div class="pricing-table-price"><h4>Previous Order Details</h4></div>
                                            <span>Items:</span>
                                        </div>
                                        <ul class="pricing-table-features list-reset text-xs">
                                            <c:forEach items="${lastOrder.items}" var="item">
                                                <li>
                                                    <p style="color: white; margin: 0; padding: 0;"> ${item.toString()}</p>
                                                </li>
                                            </c:forEach>
                                        </ul>
                                    </div>
                                    <div class="pricing-table-cta mb-8">
                                        <a class="button button-primary button-shadow button-block" href="rechargeCard">Place
                                            A New Order</a>
                                    </div>
                                </div>
                            </div>
