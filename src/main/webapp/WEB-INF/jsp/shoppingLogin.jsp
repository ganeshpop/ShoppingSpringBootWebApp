...
<head>
    ...
    <link rel="stylesheet" href='<c:url value="dist/css/shoppingLoginStyle.css"/>'>
                    ...
                    <div class="pricing-table">
                        <div class="pricing-table-inner is-revealing">
                            <div class="pricing-table-main">
                                ...
                                <spring:form action="./verifyLogin" method="post" modelAttribute="login">
                                    <ul class="pricing-table-features list-reset text-xs">
                                        <li>
                                            <span>  <label
                                                    style="width: 110px; display: inline-block">User Name : </label> <spring:input
                                                    path="userName"
                                        ...
                                        <li>
                                            <span> <label
                                                    style="width: 114px; display: inline-block"> Password  : </label><spring:input
                                                    path="password"
                                                    type="password"
                                                    maxlength="200"
                                                    cssStyle="width:50%;"/></span>
